...
class ModelCapabilitiesBottomSheet extends StatelessWidget {
  ...
  Map<String, dynamic>? _resolvePricing() {
    final dynamic raw =
        pricing ?? modelCapabilities?.pricing ?? modelData?['pricing'];
  ...
  Widget _buildCapabilitiesGrid(BuildContext context) {
    ...
    return Column(
      children: [
        // Input Modalities
        _buildCapabilitySection('Input Modalities', [
        ...
        // Context & Performance
        _buildCapabilitySection('Context & Performance', [
          ...
          if (modelCapabilities!.maxCompletionTokens != null)
            _buildCapabilityItem(
              ...
              Icons.output,
              theme,
              subtitle: _formatContextLength(
                modelCapabilities!.maxCompletionTokens!,
              ),
            ),
          _buildCapabilityItem(
            'Multimodal',
        ...
        _buildCapabilitySection('Pricing', [
          FutureBuilder<RequestUsageEstimate>(
            ...
            builder: (context, snapshot) {
              ...
              final unitsLabel = est.isFree ? 'x0 (Free)' : 'x${est.requestUnits}';
